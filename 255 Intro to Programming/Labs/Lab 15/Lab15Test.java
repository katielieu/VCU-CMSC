...
public class Lab15Test {
	...
	private void testPatternOutput(String pattern, int expected, ArrayList<Integer> answer){
		...
		try {
			Method studentPattern = Lab15.class.getMethod(pattern, int.class, answer.getClass());
			...
			fail("For some reason we aren't able to run Lab15." + pattern + ". Make sure you have the appropriate method");
		}
	}
	...
	public void pattern3Test() {
		...
		testPatternOutput("pattern3", 265, answer);
	}
	...
	public void pattern4Test() {
		...
		testPatternOutput("pattern4", 65, answer);
	}
